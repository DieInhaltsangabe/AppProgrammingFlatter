...
class Challanges extends State<ChallangesSection> {
  ...
  int challangeId = 0; // ID of currently chosen Challange
  var challangeIdDay = [0, ""]; // All data needed for current challange day
  int currentGridIndex =
      0; // for cube net view: it indicates, which cube face is shown atm
  var colors = [
    Colors.red,
    Colors.orange,
    Colors.yellow,
  ...
  /**
   * List of all possible challanges. In this case only patterns, but for the future, we could also 
   * add famous scrambles into it
   */
  List challanges = [
  ...
  String solution =
      ""; // The solution for the current challange, which will bring a solved cube to the challange pattern
  String inversedSolution =
      ""; // The solution for the current challange, which will bring a patternized cube to the solved state.
  ...
  HashMap<String, String> inverter =
      HashMap(); // Hash Map which will contain the inverted moves, important for inverted Solution
  /**
   * Inverted Moves means, if you do a move on your cube, which move will bring the cube back to previous stage.
   * E.G.   R -> R', 2F -> 2F, ...
   */

  /**
   * Method that fills the inverter HashMap with the inverted move key value pairs
   */
  void fillHashMap() {
    inverter["R"] = "R'";
    inverter["L"] = "L'";
  ...
  /**
   * A method which will receive a Solution object of the cuber package, and invert that solution (backwards algo with inverted moves)
   */
  ...
  /**
   * Method that will generate the solution of current challange and pass it to invert Alo.
   */
  ...
  /**
   * Switch currently rendered cube Face
   */
  ...
  /**
   * Load data from shared preferences. Change Challange, if the last save was a day in the past.
   */
  _loadData() async {
  ...
  /**
   * Parse Cube Notation to a renderable grid.
   */
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: Center(
            child: Column(
              children: [
                Text(AppLocalizations.of(context)!.todaysChallenge,
                    style: TextStyle(
                        fontSize: AppSettings().fontSize,
                        fontFamily: AppSettings().font)),
                const SizedBox(height: 4),
                Text(challanges[challangeId][2],
                    style: TextStyle(
                        fontSize: 50, fontFamily: AppSettings().font)),
                Center(
                    child: Text(
                  AppLocalizations.of(context)!.challangeInstruction,
                  style: TextStyle(
                      fontSize: AppSettings().fontSize,
                      fontFamily: AppSettings().font),
                  ...
                  child: Center(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: showNetwork
                            ? Text(
                                AppLocalizations.of(context)!.switchToCubeNet,
                                style: TextStyle(
                                    fontSize: AppSettings().fontSize,
                                    fontFamily: AppSettings().font,
                                    color: Theme.of(context)
                                        ...
                                        .onSurface))
                            : Text(
                                AppLocalizations.of(context)!.switchToFaceView,
                                style: TextStyle(
                                    fontSize: AppSettings().fontSize,
                                    fontFamily: AppSettings().font,
                                    color: Theme.of(context)
        ...
        return SimpleDialog(
            ...
            children: [
              Padding(
                ...
                child: Text(
                    AppLocalizations.of(context)!.challengeSolutionToPattern +
                        ": " +
                        sol,
                    style: TextStyle(
